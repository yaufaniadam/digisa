                    ...
                    <form class="w-full mt-12" action="{{ route('public.product_collections') }}" method="GET">
                        <div class="relative flex justify-between items-center border bg-white rounded-md">
                            <input
                                ...
                                id="grid-first-name" type="text" placeholder="Masukkan kata + tekan enter ..." name="search">
    ...
    <section class="py-0">
      <div class="container">
        <div class="relative sm:-mt-80 mt-0 bg-white py-10 px-0 md:px-10">
          ...
          <div
            class="grid xl:grid-cols-4 md:grid-cols-4 grid-cols-4 pt-2 md:pt-12 gap-2 md:gap-4"
          >
          ...
          <div class="grid lg:grid-cols-4 grid-cols-1 gap-6 lg:pt-16 py-5 " data-aos="fade-up">
            ...
            <div class="flex flex-row md:flex-col gap-3 md:gap-3">
                ...
                <div class="w-4/5 md:w-full">
                  ...
                  <h1 class="text-md md:text-lg md:my-2 transition-all hover:text-gray-500"><a href="{{ route('public.product_detail', $product->id) }}">{{ $product->name }}</a></h1>
                </div>              
            </div>  
          ...
          <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
              <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                <a href="#" aria-current="page" class="relative z-10 inline-flex items-center bg-green-400 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">1</a>
