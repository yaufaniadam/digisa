            ...
            <nav class="flex items-center">
                ...
                <div class="hidden lg:block ms-auto">
                    <ul class="navbar-nav flex gap-x-3 items-center justify-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('public.tentang') }}">Tentang</a>
                        </li>                    
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 flex-wrap justify-between">
                        <div>
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="text-gray-500/80">
                                    <a href="{{ route('public.tentang') }}#kontak">Kontak</a>
                                </div>
                                <div class="text-gray-500/80">
                                    <a href="https://suaraaisyiyah.id/category/digisa">Blog</a>
                                </div>
                        ...
                        <div>
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="text-gray-500/80">
                                    <a href="{{ route('public.register') }}">Daftar</a>
                                </div>
